    ...
    <>
      ...
      <div className="w-3/4 flex flex-col mt-5 ms-10 gap-8 lg:ms-20 lg:mr-10">
        ...
        <div className="text-base font-semibold" dir="rtl">
          در سایت <span className="text-[#28d16c]">&quot;درخت من&quot;</span>،
          ما به شما این امکان را می‌دهیم که با کاشت درختان، داستان‌های خاص و
          یادگاری‌های ماندگار بسازید. یکی از ویژگی‌های منحصر به فرد ما، نمایش
          محل دقیق کاشت درختان شما همراه با تم‌های متنوع است.{" "}
