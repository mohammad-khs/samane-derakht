      ...
      <section className="flex flex-col md:flex-row justify-center mx-5 md:mx-10 items-center my-20">
        ...
        <div className="w-3/4 flex flex-col mt-10 md:mt-5 ms-10 gap-8 lg:ms-20 lg:mr-10">
          ...
          <div className="text-base font-semibold border-r-4 pr-3">
            سامانه <span className="text-[#28d16c]" >"درخت من"</span> به شما این امکان را می‌دهد که به صورت آنلاین درختی
            بکارید و به حفظ محیط زیست کمک کنید. کاربران می‌توانند درخت خود را با
            تم‌های مختلف برای مناسبت‌های خاص انتخاب کرده و داستانی شخصی برای آن
            بنویسند. هر درخت همراه با QR کدی است که به داستان آن لینک می‌شود و
            امکان اشتراک‌گذاری آن با دیگران را فراهم می‌آورد. این پلتفرم
            تجربه‌ای منحصر به فرد و پایدار از ارتباط با طبیعت را به ارمغان
            می‌آورد.
          </div>
        </div>
      </section>
