      ...
      <div className="flex justify-center rounded-lg relative">
        <div className="carousel flex items-center justify-between">
          ...
          <div className="relative carousel-item text-center py-2 h-[650px] w-[360px]">
            <button
              className="absolute my-2 z-50 right-2 hover:text-black transition-colors text-gray-800"
              onClick={onClose}
            >
            ...
            {imageData?.image === "loading" ? (
              ...
              <>
                ...
                <div className="absolute mx-2 z-50 h-full flex justify-center items-center flex-col">
                  <EyeIcon />
                  <p className="">{imageData?.seen_numbers}</p>
                </div>
              </>
            ) : (
              <>
                <div className="w-full h-full z-40 bg-slate-700 flex justify-center items-center">
                  ...
                  <div className="absolute top-0 left-0 mx-2 z-50 h-full flex items-center">
