      ...
      <footer>
        ...
        <div className="relative bg-[#20AC58] pt-10 pb-5">
          ...
          <div className="flex  flex-col-reverse md:flex-row text-white px-10">
            <div className="basis-2/4 flex w-full gap-5 justify-around z-0">
            ...
            <div className="basis-2/4 flex flex-col mb-8 md:mb-0 items-center z-0">
          ...
          <div className="w-full  flex justify-center">
            <div className="w-3/5 text-xs mt-5 md:text-sm lg:text-base flex flex-col lg:flex-row justify-center md:justify-between z-0">
